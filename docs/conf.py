...
project = 'org-id.guide: contributors handbook'
copyright = '2016-2017, Open Data Services Co-operative'
...
latex_documents = [
    (master_doc, 'sphinx.tex', 'org-id.guide handbook',
     'org-id.guide', 'manual'),
]
...
man_pages = [
    (master_doc, 'sphinx', 'org-id.guide: contributors handbook',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'sphinx', 'org-id.guide: contributors handbook',
     author, 'sphinx', 'making information about organizations usable and useful',
     'open data'),
]
